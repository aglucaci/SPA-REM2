...
def marginalPlot(species, YAxis, YAxisTitle):
    ...
    # Combine charts
    outputFilenamePNG = 'RMSD-view-SPA-REM2-' + YAxis.replace(" ", "") + '-TN93-' + species + '.png'
    outputFilenameSVG = 'RMSD-view-SPA-REM2-' + YAxis.replace(" ", "") + '-TN93-' + species + '.svg'
